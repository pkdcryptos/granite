...
class UserNotificationTest < ActiveSupport::TestCase
  ...
  def test_last_notification_sent_date_must_be_present
    ...
    puts "user_notification.errors.messages: #{@user_notification.errors.messages[:last_notification_sent_date]}"
    puts "errors.messages.blank: #{t('errors.messages.blank')}"
